...
> **Tip**
>
> Les champs `Borne de température inférieure` et `Borne de température supérieure` définissent la plage de fonctionnement du thermostat en dehors de laquelle une défaillance de sonde est enclenchée. Voir ci-dessous le paragraphe sur les actions de défaillance.
