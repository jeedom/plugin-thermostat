...
![Aspect sur le dashboard](../images/.png)
...
![Configuração générale](../images/_config_générale.png)
...
![Choix de l'algorithme](../images/31.png)
...
![Actions sur les appares](../images/actionssurappare.png)
...
![Configuração des vertures](../images/configvertures.png)

 :

-   sélectionnez l'info du capteur d'verture dans le champ `Ouverture`
...
![Défalance des sondes](../images/defalancesonde.png)
...
> 
> *. 
> `Marge de défalance chaud` pr le Aquecimento et de la
> `Marge de défalance froid` pr la climatisation.



.

![Défalance ](../images/defalanceAquecimento.png)
...
-   **Tempo de aquecimento mínimo (% do ciclo)** : 
...
![Scénario programmé](../images/11.png)
...
Dans le menu `Accue`, on trve le ss-menu ``. 
